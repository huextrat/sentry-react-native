...
- Bump Bundler Plugins from v5.1.1 to v5.3.0 ([#8](https://github.com/huextrat/sentry-react-native/pull/8))
  - [changelog](https://github.com/getsentry/sentry-javascript-bundler-plugins/blob/main/CHANGELOG.md#530)
  - [diff](https://github.com/getsentry/sentry-javascript-bundler-plugins/compare/5.1.1...5.3.0)
